...
with open('neural_network_model_project2_funny.pkl', 'rb') as f:
    model = pickle.load(f)
...
labels = torch.tensor(data['funny'])  # Subtract 1 to convert labels to start from 0 for classification

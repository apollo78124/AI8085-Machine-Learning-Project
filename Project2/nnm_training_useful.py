...
labels = torch.tensor(data['useful'] - 1)  # Subtract 1 to convert labels to start from 0 for classification
...
with open('neural_network_model_project2_useful.pkl', 'wb') as f:
    pickle.dump(model, f)
